        ...
        private void InfoThread()
        {
            ...
            while (true)
            {
                ...
                for (int i = 0; i < entityCount; i++)
                {
                    ...
                    //if (entityType.Length > 0) Console.WriteLine("TYPE > " + entityType);
                    //Console.WriteLine("TYPE > " + BitConverter.ToString(Mem.ReadMemory(entityEntry + i, 5000)).Replace("-", string.Empty));
